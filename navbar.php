      ...
      <li class="relative group cursor-pointer">
        ...
        <ul
          ...
          <li><a href="/do-an-1/detail.php?describe=the-loai&type=chien-tranh"
              class="hover:text-blue-500 px-2 py-3">Chiến
              Tranh</a></li>
          ...
          <li><a href="/do-an-1/detail.php?describe=the-loai&type=bi-an" class="hover:text-blue-500 px-2 py-3">Bí
              Ẩn</a>
          </li>
          ...
          <li><a href="/do-an-1/detail.php?describe=the-loai&type=chinh-kich"
              class="hover:text-blue-500 px-2 py-3">Chính
              Kịch</a>
          </li>
      ...
      <li class="relative group cursor-pointer">
        ...
        <ul
          ...
          <li><a href="/do-an-1/detail.php?describe=quoc-gia&type=trung-quoc"
              class="hover:text-blue-500 px-2 py-3">Trung
              Quốc</a>
          </li>
          ...
          <li><a href="/do-an-1/detail.php?describe=quoc-gia&type=mexico"
              class="hover:text-blue-500 px-2 py-3">Mexico</a>
          </li>
          ...
          <li><a href="/do-an-1/detail.php?describe=quoc-gia&type=philippines"
              class="hover:text-blue-500 px-2 py-3">Philippines</a>
          </li>
          ...
          <li><a href="/do-an-1/detail.php?describe=quoc-gia&type=au-my" class="hover:text-blue-500 px-2 py-3">Âu
              Mỹ</a>
          </li>
          <li><a href="/do-an-1/detail.php?describe=quoc-gia&type=an-do" class="hover:text-blue-500 px-2 py-3">Ấn
              Độ</a>
          </li>
          <li><a href="/do-an-1/detail.php?describe=quoc-gia&type=canada"
              class="hover:text-blue-500 px-2 py-3">Canada</a>
          </li>
          ...
          <li><a href="/do-an-1/detail.php?describe=quoc-gia&type=indonesia"
              class="hover:text-blue-500 px-2 py-3">Indonesia</a>
          </li>
          ...
          <li><a href="/do-an-1/detail.php?describe=quoc-gia&type=malaysia"
              class="hover:text-blue-500 px-2 py-3">Malaysia</a>
          </li>
          ...
          <li><a href="/do-an-1/detail.php?describe=quoc-gia&type=quoc-gia-khac"
              class="hover:text-blue-500 px-2 py-3">Quốc
              Gia
              Khác</a></li>
          ...
          <li><a href="/do-an-1/detail.php?describe=quoc-gia&type=brazil"
              class="hover:text-blue-500 px-2 py-3">Brazil</a>
          </li>
          <li><a href="/do-an-1/detail.php?describe=quoc-gia&type=y" class="hover:text-blue-500 px-2 py-3">Ý</a>
          </li>
          <li><a href="/do-an-1/detail.php?describe=quoc-gia&type=na-uy" class="hover:text-blue-500 px-2 py-3">Na
              Uy</a>
          </li>
